...
describe ElasticNewsItem do
  ...
  before do
    ...
    @gallery_item = NewsItem.create!(
      ...
      description: '<p>that is the policy.</p><p>This is a paragraph full of other, less relevant words. These are more random words to ensure that the relevance calculation is comparing document fields of similar lengths.<\p>',
      contributor: 'President',
      publisher: 'Briefing Room',
      subject: 'HIV',
