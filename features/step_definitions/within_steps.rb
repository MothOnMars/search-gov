{
  ...
  'in the rss feed govbox': '#news-items',
  'in the legacy rss feed govbox': '#news_items_govbox',
  'in the video rss feed govbox': '#video-news-items',
  'in the legacy video rss feed govbox': '#video_news_items_govbox',
